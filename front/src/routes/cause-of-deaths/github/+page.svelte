<script>
    ...
    let redirect_uri = "https://sos2324-21.appspot.com/cause-of-deaths/github"
    //let redirect_uri = 'http://localhost:12345/cause-of-deaths/github';
    ...
    async function callApi(method, url) {
        const res = await fetch(API + '/getGH_info' + '?access_token=' + access_token_gh + '&url=' + encodeURIComponent(url), {
            method: method
        });
